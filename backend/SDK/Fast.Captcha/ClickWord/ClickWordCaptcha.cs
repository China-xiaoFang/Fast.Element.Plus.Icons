...
namespace Fast.Captcha.ClickWord;
...
public class ClickWordCaptcha : IClickWordCaptcha, ITransient
{
    ...
    public ClickWordCaptcha(IMemoryCache cache)
    {
        _cache = cache;
    }
    ...
    /// <returns></returns>
    public async Task<ClickWordCaptchaResult> CheckCode(ClickWordCaptchaInput input)
    {
