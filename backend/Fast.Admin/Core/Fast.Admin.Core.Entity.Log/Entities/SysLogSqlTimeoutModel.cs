...
/// <summary>
/// <see cref="SysLogSqlTimeoutModel"/> 系统Sql超时日志表Model类
/// </summary>
[SugarTable("Sys_Log_Sql_Timeout", "系统Sql超时日志表")]
[SugarDbType(FastDbTypeEnum.SysCoreLog)]
public class SysLogSqlTimeoutModel : BaseIdentityRecordEntity
{
    /// <summary>
    /// 操作人账号
    /// </summary>
    ...
    /// 超时秒数
    /// </summary>
    [SugarColumn(ColumnDescription = "超时秒数", IsNullable = true)]
    ...
    /// 超时时间
    /// </summary>
    [SugarColumn(ColumnDescription = "超时时间", ColumnDataType = "datetimeoffset", IsNullable = false)]
