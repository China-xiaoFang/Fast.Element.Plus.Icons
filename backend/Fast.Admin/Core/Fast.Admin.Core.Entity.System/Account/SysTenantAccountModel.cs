...
namespace Fast.Admin.Core.Entity.System.Account;

/// <summary>
/// <see cref="SysTenantAccountModel"/> 租户系统账户信息表Model类
/// </summary>
[SugarTable("Sys_Tenant_Account", "租户系统账户信息表")]
[SugarDbType(FastDbTypeEnum.SysCore)]
public class SysTenantAccountModel : BaseTEntity
{
    /// <summary>
    /// 账号ID
    /// </summary>
    ...
    /// 系统账号信息
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(AccountId))]
    public SysAccountModel SysAccount { get; set; }

    /// <summary>
    /// 系统租户信息
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(TenantId))]
    public SysTenantModel SysTenant { get; set; }
}