...
/// <summary>
/// <see cref="SysAccountModel"/> 系统账户信息表Model类
/// </summary>
[SugarTable("Sys_Account", "系统账户信息表")]
[SugarDbType(FastDbTypeEnum.SysCore)]
public class SysAccountModel : BaseEntity
{
    /// <summary>
    /// 账户
    /// </summary>
    [SugarColumn(ColumnDescription = "账户", ColumnDataType = "Nvarchar(20)", IsNullable = false,
