...
using Fast.Core.UnifyResult.Filters;
...
public static class UnifyResultServiceCollectionExtensions
{
        ...
        where TUnifyResultProvider : class, IUnifyResultProvider
    {
        ...
        // 创建规范化元数据
        var metadata = new UnifyMetadata {ProviderName = providerName, ProviderType = providerType, ResultType = resultType};
    ...
    /// <param name="serializerSettings"></param>
    /// <returns></returns>
    public static IServiceCollection AddUnifyJsonOptions(this IServiceCollection services, string providerName,
