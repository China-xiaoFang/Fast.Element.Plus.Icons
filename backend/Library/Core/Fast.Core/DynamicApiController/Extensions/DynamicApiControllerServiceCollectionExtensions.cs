...
using Fast.Core.DynamicApiController.Conventions;
...
using Fast.Core.DynamicApiController.Runtimes;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.ApplicationParts;
using Microsoft.AspNetCore.Mvc.Infrastructure;
using Microsoft.Extensions.DependencyInjection;

namespace Fast.Core.DynamicApiController.Extensions;
...
public static class DynamicApiControllerServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddDynamicApiControllers(this IServiceCollection services)
    {
        ...
        services.AddSingleton<MvcActionDescriptorChangeProvider>()
            .AddSingleton<IActionDescriptorChangeProvider>(provider =>
                provider.GetRequiredService<MvcActionDescriptorChangeProvider>());
