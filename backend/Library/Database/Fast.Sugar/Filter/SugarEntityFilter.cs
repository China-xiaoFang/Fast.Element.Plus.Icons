        ...
        _db.Aop.DataExecuting = (oldValue, entityInfo) =>
        {
            ...
            switch (entityInfo.OperationType)
            {
                ...
                case DataFilterType.InsertByObject:
                    ...
                    // 创建者名称
                    SetEntityValue(nameof(IBaseEntity.CreatedUserName), new List<dynamic> {null, ""}, userInfo.UserName,
                        ref entityInfo);
                ...
                case DataFilterType.UpdateByObject:
                    ...
                    // 更新者Id
                    SetEntityValue(nameof(IBaseEntity.UpdatedUserId), null, userInfo.UserId, ref entityInfo);

                    // 更新者名称
                    SetEntityValue(nameof(IBaseEntity.UpdatedUserName), null, userInfo.UserName, ref entityInfo);
                    break;
            }
        };
