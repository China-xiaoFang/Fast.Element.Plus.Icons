...
namespace Fast.Sugar.Options;

public class ConnectionConfigOption : BaseTenant
{
    /// <summary>
    /// SqlSugarClient 连接Id
    /// </summary>
    ...
    [SugarColumn(ColumnDescription = "DataBase Info 表名称", ColumnDataType = "Nvarchar(50)", IsNullable = false)]
    public string DbInfoTableName { get; set; }
}