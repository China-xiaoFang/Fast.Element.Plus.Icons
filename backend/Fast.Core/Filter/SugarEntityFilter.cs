...
static class SugarEntityFilter
{
    ...
    public static void LoadSugarFilter(ISqlSugarClient _db, int commandTimeOut, double sugarSqlExecMaxSeconds, bool diffLog)
    {
        ...
        _db.Aop.DataExecuting = (oldValue, entityInfo) =>
        {
            ...
            switch (entityInfo.OperationType)
            {
                ...
                case DataFilterType.InsertByObject:
                    ...
                    // 租户Id
                    SetEntityValue(SugarFieldConst.TenantId, new List<dynamic> {null, 0}, GlobalContext.TenantId, ref entityInfo);

                    // 创建者Id
                    SetEntityValue(SugarFieldConst.CreatedUserId, new List<dynamic> {null, 0}, GlobalContext.UserId,
                        ref entityInfo);

                    // 创建者名称
                    SetEntityValue(SugarFieldConst.CreatedUserName, new List<dynamic> {null, ""}, GlobalContext.UserName,
                        ref entityInfo);
                ...
                case DataFilterType.UpdateByObject:
                    ...
                    // 更新者Id
                    SetEntityValue(SugarFieldConst.UpdatedUserId, null, GlobalContext.UserId, ref entityInfo);

                    // 更新者名称
                    SetEntityValue(SugarFieldConst.UpdatedUserName, null, GlobalContext.UserName, ref entityInfo);
                    break;
            }
        };
        ...
        if (!GlobalContext.IsSuperAdmin)
        {
            ...
            _db.QueryFilter.AddTableFilter<IBaseTenant>(it => it.TenantId == GlobalContext.GetTenantId(false));
        }
