...
global using static Fast.Core.AttributeFilter.Http.HttpGetAttribute;
global using static Fast.Core.AttributeFilter.Http.HttpPostAttribute;
global using static Fast.Core.AttributeFilter.Http.HttpPutAttribute;
global using static Fast.Core.AttributeFilter.Http.HttpDeleteAttribute;
global using Fast.Core.Cache;
global using Fast.Core.SqlSugar;
global using Fast.Core.SqlSugar.Extension;
global using Fast.Core.SqlSugar.Internal;
global using Fast.Core.SqlSugar.Repository;
