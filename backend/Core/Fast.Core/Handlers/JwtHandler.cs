...
public class JwtHandler : AppAuthorizeHandler
{
        ...
        string tokenPrefix = "Bearer ", long clockSkew = 5L)
    {
        ...
        var jwtBearerToken = JWTEncryption.GetJwtBearerToken(httpContext, CommonConst.AuthAccessToken, tokenPrefix);
        var jwtBearerRefreshToken = JWTEncryption.GetJwtBearerToken(httpContext, CommonConst.AuthRefreshToken, tokenPrefix);
        ...
        var refreshTokenExpiredTime = ConfigOperation.Tenant.GetConfig(ConfigConst.Tenant.RefreshTokenExpiredTime).Value
            .ParseToInt();
        httpContext.Response.Headers[CommonConst.AccessToken] = refreshToken;
        httpContext.Response.Headers[CommonConst.RefreshToken] =
        ...
        httpContext.Response.Headers[key] = string.Join(',',
            StringValues.Concat(value, new StringValues(new[] {CommonConst.AccessToken, CommonConst.RefreshToken})).Distinct());
        return true;
    }
