...
public static class SqlSugarSetup
{
    ...
    public static void AddSqlSugarClientService(this IServiceCollection service)
    {
        ...
        // 得到连接字符串
        var connectionStr = DataBaseHelper.GetConnectionStr(defaultDataBaseInfo);
        ...
        var connectConfig = new ConnectionConfig
        {
            ...
            ConfigureExternalServices = DataBaseHelper.GetSugarExternalServices(defaultDataBaseInfo.DbType)
        };
