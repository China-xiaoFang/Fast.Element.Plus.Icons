...
public class RequestInfoMiddleware
{
    ...
    {
        // 响应报文头增加环境变量
        context.Response.Headers[CommonConst.EnvironmentName] = GlobalContext.SystemSettingsOptions.Environment.ParseToString();

        // 响应报文头增加接口版本
        context.Response.Headers[CommonConst.ApiVersion] = GlobalContext.SystemSettingsOptions.ApiVersion;

        // 响应报文头增加接口操作类型
        context.Response.Headers[CommonConst.ApiActionName] = (context.Request.Method switch
        {
