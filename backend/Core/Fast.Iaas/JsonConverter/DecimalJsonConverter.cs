...
public class DecimalJsonConverter : JsonConverter<decimal>
{
    ...
    {
        writer.WriteNumberValue(Places == null ? value.GetDecimal() : Math.Round(value, Places.Value));
    }
}
...
public class NullableDecimalJsonConverter : JsonConverter<decimal?>
{
    ...
    public override void Write(Utf8JsonWriter writer, decimal? value, JsonSerializerOptions options)
    {
        if (value == null)
            ...
            writer.WriteNumberValue(Places == null ? value.Value.GetDecimal() : Math.Round(value.Value, Places.Value));
    }
}