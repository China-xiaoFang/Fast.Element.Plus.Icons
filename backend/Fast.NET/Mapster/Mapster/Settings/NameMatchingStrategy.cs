...
public class NameMatchingStrategy : IApplyable<NameMatchingStrategy>
{
    ...
    {
        SourceMemberNameConverter = MapsterHelper.Identity, DestinationMemberNameConverter = MapsterHelper.Identity,
    };

    public static readonly NameMatchingStrategy Flexible = new NameMatchingStrategy
    {
        SourceMemberNameConverter = MapsterHelper.PascalCase, DestinationMemberNameConverter = MapsterHelper.PascalCase,
    };

    public static readonly NameMatchingStrategy IgnoreCase = new NameMatchingStrategy
    {
        SourceMemberNameConverter = MapsterHelper.LowerCase, DestinationMemberNameConverter = MapsterHelper.LowerCase,
    };

    public static readonly NameMatchingStrategy ToCamelCase = new NameMatchingStrategy
    {
        SourceMemberNameConverter = MapsterHelper.CamelCase, DestinationMemberNameConverter = MapsterHelper.Identity,
    };

    public static readonly NameMatchingStrategy FromCamelCase = new NameMatchingStrategy
    {
        SourceMemberNameConverter = MapsterHelper.Identity, DestinationMemberNameConverter = MapsterHelper.CamelCase,
    };
    ...
    public static NameMatchingStrategy ConvertSourceMemberName(Func<string, string> nameConverter)
    {
        ...
        {
            SourceMemberNameConverter = nameConverter, DestinationMemberNameConverter = MapsterHelper.Identity,
        };
    }
    ...
    public static NameMatchingStrategy ConvertDestinationMemberName(Func<string, string> nameConverter)
    {
        return new NameMatchingStrategy
        {
            SourceMemberNameConverter = MapsterHelper.Identity, DestinationMemberNameConverter = nameConverter,
        };
    }
