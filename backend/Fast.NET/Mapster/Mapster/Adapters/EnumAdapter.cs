...
internal class EnumAdapter : PrimitiveAdapter
{
    ...
    {
        return CanMap(arg.SourceType, arg.DestinationType) || CanMap(arg.DestinationType, arg.SourceType);
    }
    ...
    static bool CanMap(Type type1, Type type2)
    {
        ...
        return type2.GetTypeInfo().IsEnum || type2 == typeof(string) || type2 == typeof(byte) || type2 == typeof(sbyte) ||
               type2 == typeof(short) || type2 == typeof(ushort) || type2 == typeof(int) || type2 == typeof(uint) ||
               type2 == typeof(long) || type2 == typeof(ulong);
    }
    ...
    protected override Expression ConvertType(Expression source, Type destinationType, CompileArgument arg)
    {
        ...
        if (destinationType.GetTypeInfo().IsEnum && srcType.GetTypeInfo().IsEnum && arg.Settings.MapEnumByName == true)
        {
            var method = typeof(Enum<>).MakeGenericType(srcType).GetMethod("ToString", new[] {srcType});
