...
sealed class ParameterExpressionReplacer : ExpressionVisitor
{
    ...
    protected override Expression VisitConditional(ConditionalExpression node)
    {
        ...
        var leftIsNull = bin.Left.NodeType == ExpressionType.Constant && ((ConstantExpression) bin.Left).Value == null;
        var rightIsNull = bin.Right.NodeType == ExpressionType.Constant && ((ConstantExpression) bin.Right).Value == null;
