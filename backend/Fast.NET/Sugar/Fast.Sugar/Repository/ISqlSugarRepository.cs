...
public interface ISqlSugarRepository<TEntity> where TEntity : class, new()
{
    ...
    /// 当前仓储的数据库信息
    /// </summary>
    ConnectionConfigOption DataBaseInfo { get; }
  ...
  /// <returns></returns>
    ...
    /// <returns></returns>
    SqlSugarPagedList<TEntity> ToPagedList(int pageIndex, int pageSize);
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<SqlSugarPagedList<TEntity>> ToPagedListAsync(int pageIndex, int pageSize);
    ...
    /// <returns></returns>
    SqlSugarPagedList<TResult> ToPagedList<TResult>(int pageIndex, int pageSize, Expression<Func<TEntity, TResult>> expression);
    ...
    /// <param name="expression"></param>
    /// <returns></returns>
    Task<SqlSugarPagedList<TResult>> ToPagedListAsync<TResult>(int pageIndex, int pageSize,
