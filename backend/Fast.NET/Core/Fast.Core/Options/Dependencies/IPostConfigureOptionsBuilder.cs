...
namespace Fast.Core.Options.Dependencies;
...
public interface IPostConfigureOptionsBuilder<TOptions> : IOptionsBuilderDependency<TOptions> where TOptions : class
{
    /// <summary>
    /// 选项后期配置
    /// </summary>
