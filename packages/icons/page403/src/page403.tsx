...
export default defineComponent({
	...
	render() {
		return (
			<ElIcon {...this.attrs} class="fa-icon fa-icon-Page403 icon">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
					...
					<g fill="none" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166">
						...
						/>
						<path d="M127.46 215.32a11.24 11.24 0 0 0-22.47 0 11 11 0 0 0 5.9 9.68L109 244.38h14.45L121.56 225a11 11 0 0 0 5.9-9.68z" />
					</g>
					<path
						fill="#263238"
						stroke="#263238"
					...
					/>
					<circle cx="225.35" cy="223.52" r="1.82" fill="#4c4c4c" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166" />
					<path
						fill="#263238"
						stroke="#263238"
						stroke-linecap="round"
					...
					/>
					<circle cx="181.95" cy="223.52" r="1.82" fill="#4c4c4c" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166" />
					<path fill="#4c4c4c" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166" d="M173.13 261.25h60.63v9.54h-60.63z" />
					<rect
						x="168.92"
						y="261.81"
						width="18.53"
					...
					<rect
						...
						stroke-width="1.166"
					/>
					<path fill="#fff" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166" d="M197.83 261.81h13.19v8.42h-13.19z" />
					<path d="M156.28 241.32s-8.42-.56-11.51-5.9" fill="none" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166" />
					<ellipse
						cx="249.9"
						cy="202.02"
						rx="13.9"
					...
					<g>
						<path fill="#263238" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M86.87 446.5H72.61l19.01-132.51h14.26L86.87 446.5z" />
						<path fill="#fff" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M115.39 446.5h14.25l-19.01-132.51H96.38l19.01 132.51z" />
						<path fill="#263238" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M289.18 446.5h-14.25l19-132.51h14.26L289.18 446.5z" />
						<path fill="#fff" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M317.7 446.5h14.25l-19.01-132.51h-14.25L317.7 446.5z" />
						<path fill="#409eff" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M55.73 293.21h271.93v26.36H55.73z" />
						<path fill="#409eff" stroke="#263238" stroke-miterlimit="10" stroke-width="1.166" d="M62.36 293.21h271.93v26.36H62.36z" />
						<path
							fill="#263238"
					...
					<g fill="none" stroke="#263238" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.166">
						<path d="M450.01 446.5h6.91M39.37 446.5h400.99" />
					</g>
				</svg>
			</ElIcon>
		);
